...
namespace xl2cad_cad
{
    public class zDBText
    {
        ...
        public void zdbtext()
        {
            ...
            int columnCountofSelect = EntityCollection.Count;
            double dis = 0;
                    ...
                    try
                    {
                        for (int i = 0; i < rowCountofSource; i++)
                        {
                            for (int j = 0; j < EntityCollection.Count; j++)
                            {
                                ...
                                newEnt.TransformBy(Matrix3d.Displacement(new Vector3d(0, (-1 * dis * (i + 1)), 0)));
            ...
            //    try
            //    {
            //        Entity ent = EntityCollection[0] as Entity;
            //        ent.Erase(true);
            //        transaction.Commit();
